...
final class RecipeECFPCell: UITableViewCell {
    ...
    private func setCarbohydratesViewLabelConstraints() {
        ...
        carbohydratesViewLabel.topAnchor.constraint(equalTo: carbohydratesView.topAnchor, constant: 8)
            .isActive = true
    ...
    private func setCarbohydratesSubViewLabelConstraints() {
        ...
        carbohydratesSubViewLabel.trailingAnchor.constraint(equalTo: carbohydratesView.trailingAnchor)
            .isActive = true
